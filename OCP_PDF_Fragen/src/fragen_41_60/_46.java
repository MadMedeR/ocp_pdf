...
B. public abstract class Work implements Doable {
 public abstract void doSomething(String s) { } public void doYourThing(Boolean b) { } }
...
public void doSomething(Integer i) { } 
 ...
 // https://www.briefmenow.org/oracle/which-two-class-definitions-compile/  Frage 8
 // Answer AE
